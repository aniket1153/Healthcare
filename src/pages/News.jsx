...
import img1 from "../assets/NewsMain.jpg"
...
const News = () => {
  const guides = [
    { id: 1, img: img2, title: "10 Everyday Habits for Better Heart Health", date: "29 Jul, 6:12 PM" },
    { id: 2, img: img3, title: "Breakthroughs in Cancer Research This Year", date: "29 Jul, 6:12 PM" },
    { id: 3, img: img4, title: "Managing Diabetes: Daily Tips from Doctors", date: "29 Jul, 6:12 PM" },
    { id: 4, img: img5, title: "How to Stay Hydrated the Smart Way", date: "29 Jul, 6:12 PM" },
    { id: 5, img: img6, title: "How to Boost Your Immunity Naturally", date: "29 Jul, 6:12 PM" },
    { id: 6, img: img7, title: "Yoga vs. Gym: Which One Is Better for Your Health?", date: "29 Jul, 6:12 PM" },
    { id: 7, img: img8, title: "Top 5 Myths About Vaccines Busted by Science", date: "29 Jul, 6:12 PM" },
    { id: 8, img: img9, title: "What You Need to Know About Mental Health in 2025", date: "29 Jul, 6:12 PM" },
  ]
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 place-items-center sm:p-1 lg:p-27">
        {currentGuides.map((guide) => (
          ...
          >
            ...
            />
            {/* Overlay */}
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent flex flex-col gap-2 justify-end p-4 text-white">
