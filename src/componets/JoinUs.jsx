...
<div className='bg-gray-300/80 text-white p-5  rounded-full shadow-lg group-hover:bg-[#006E58] group-hover:text-white transition cursor-pointer'>
 <FaPlay size={24} />
</div>
</div>
      </div>
...
<div className="flex flex-col lg:flex-row justify-between items-center gap-6 p-8 w-[80%] mx-auto">
  ...
  <div>
    <button className="flex items-center gap-2 h-12 sm:h-14 px-6 sm:px-8 bg-[#006E58] text-white rounded-full hover:bg-[#004235] transition  cursor-pointer">
